...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Path connectorSdkRoot = executingAssemblyLocation.getParent().getParent().getParent();
        String searchPath = connectorSdkRoot.toString() + "/*seeq-link-connector*/target/classes";

        config.setConnectorSearchPaths(searchPath);

        new Program().run(new com.seeq.link.agent.ClassFactory(), new com.seeq.link.sdk.ClassFactory(), config);
    }
